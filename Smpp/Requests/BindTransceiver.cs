...
namespace Smpp.Requests
{
    ...
    /// </summary>
    public class BindTransceiver : Pdu
    {
        #region private
        ...
        public BindTransceiver(string pdu) : base(pdu)
        {
            Decode();
        }
        ...
        public override string Encode()
        {
            ...
            response.Append(BuildHeader(Common.CommandId.bind_transceiver, 0, sequence_number));
